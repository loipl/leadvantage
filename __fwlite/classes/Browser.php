...
class Browser
{
    ...
    const DEFAUT_CHROME_VERSION = '35';            // current chrome version Chrome/35 (2014/06/24)
    ...
    */
    ...
    protected function checkBrowserInternetExplorer()
    {
        ...
        if (stripos($this->_agent, 'microsoft internet explorer') !== false) {
			...
			isset($result[1]) ? $this->setVersion(preg_replace('/[^0-9.]+/', '', $result[1])) : "";
            ...
            if (stripos($this->_agent, 'mspie') !== false) {
                isset($aresult[1]) ? $this->setVersion($aresult[1]) : "";
            } else {
                $aversion = explode('/', $this->_agent);
                isset($aversion[1]) ? $this->setVersion($aversion[1]) : "";
            }
            return true;
        }
        return false;
