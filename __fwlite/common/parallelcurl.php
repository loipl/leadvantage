...
class ParallelCurl {
    ...
    public function startRequest($url, $callback, $user_data = array(), $timeout, $post_fields=null, $posting_type = null) {
        ...
        if (!empty($urlComponents['user']) && !empty($urlComponents['pass'])) {
            ...
            $url = str_replace($urlComponents['user']. ':' . $urlComponents['pass'].'@', '', $url);
        }
        
        curl_setopt($ch, CURLOPT_URL, $url);
        
        if (!empty($post_fields) && !empty($posting_type)) {
            ...
            switch($posting_type) {
                ...
                case Model_Partner::POST_TYPE_XML_FIELD:
                    ...
                    if ($posting_type == Model_Partner::POST_TYPE_XML_FIELD) {
