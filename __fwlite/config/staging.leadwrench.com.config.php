...
Config::$siteTitle      = 'Staging Lead Wrench';
...
DB::$db   = new DB('dbserver', 'pingtree', 'Qh6EFXFV8XsYRMLS', 'pingtree');
DB::$wpDb = new DB('dbserver', 'leadwrench', 'SFXMLRA89sENEUQ4', 'leadwrench');
...
function domLog($data) {
    $fh = fopen('/home/httpd/html/leadwrench.com/log/debug.log','a');
    fputs($fh,$data);
    fclose($fh);
}