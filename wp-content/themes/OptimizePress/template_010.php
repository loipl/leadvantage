...
<style>
body{font-family:<?=$mainbodytextfont?>;}
...
<div class="pdficon"><img src="<?=$url?>/images/template010-pdficon.png" width="118" height="223" <?php echo ($postcustom['_optthemes_js1message']) ? ' OnClick="show_alert()"' : ''; ?> style="cursor:pointer;"  /></div>
<?php } ?>
...
<center><img src="<?=$url?>/images/template010-downloadbutton.png" width="333" height="92" <?php echo ($postcustom['_optthemes_js1message']) ? ' OnClick="show_alert()"' : ''; ?> style="cursor:pointer;" /></center>
<?php } ?>
</div><!--close left1-->


<div class="largearrow"><img src="<?=$url?>/images/arrows-animated.gif" width="211" height="421" />
