...
.main-preheadline{color:#<?=$mainpreheadline?> !important;<?=$preheadlinecss?>;}
.main-preheadline em{color:#<?=$mainpreheadlineem?> !important;<?=$preheadlinecss?>;}

.main-headline{color:#<?=$headlinecolor?> !important;<?=$headlinecss?>;}
.main-headline em{color:#<?=$headlinecolorem?> !important;<?=$headlinecss?>;}

.main-bottomheadline{color:#<?=$mainbottomheadline?> !important;<?=$bottomheadlinecss?>;}
.main-bottomheadline em{color:#<?=$mainbottomheadlineem?> !important;<?=$bottomheadlinecss?>;}

.main-postheadline{color:#<?=$mainpostheadline?> !important;<?=$postheadlinecss?>;}
.main-postheadline em{color:#<?=$mainpostheadlineem?> !important;<?=$postheadlinecss?>;}
...
echo ($customtrackingcodeheader) ? eval('?>'.nl2br(stripcslashes(stripslashes($customtrackingcodeheader)))) : ""; ?>
</head>
<body>
