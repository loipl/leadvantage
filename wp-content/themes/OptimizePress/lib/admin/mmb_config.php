...
$mmb_options = array (
		...
		array(	"name" => "WP Login Page Logo/Image URL",
			"desc" => "Customize the look of your Wordpress login page.  Enter login page logo image URL here, or click the 'Upload Image' button to upload your logo (Max width 326px). <br><br>To preview your page <a href='/wp-login.php' target='_blank'>click here</a>",
