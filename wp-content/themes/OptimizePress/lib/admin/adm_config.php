...
?>
  ...
  <div style="background-color:#EEF9FF;border:1px solid #B2D9EE;padding-left:20px;color:#1c5675;margin-top:0px;padding-top:14px;padding-bottom:14px;padding-right:20px;">
    <p><center><strong><a href="http://www.optimizepress.com/dashboard/launch-setup/" target="_blank">Click here to view the Launch Setup Tutorials</a></strong></center></p><br />
      ...
      <div class="field-left">
        ...
        <label>
          ...
          <div class="field-right">
           (see explaination above or <a href="http://www.optimizepress.com/dashboard" target="_blank">click here</a>) for more information
          </div>
