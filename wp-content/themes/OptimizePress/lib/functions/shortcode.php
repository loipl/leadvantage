...
function optpress_video( $atts, $content = null ) {
	...
	$out .= '<embed id="'.$video_id.'" name="'.$video_id.'" src="'.get_bloginfo('template_directory').'/js/player.swf" width="'.$width.'" height="'.$height.'" allowscriptaccess="always" allowfullscreen="true" flashvars="file='.$video_url.'&stretching=exactfit&image='.$video_image.'&controlbar='.$controlbar.'&screencolor=FFFFFF&backcolor=1b1b1b&frontcolor=FFFFFF&lightcolor=1173ba"/>';
	$out .= '</object>';
