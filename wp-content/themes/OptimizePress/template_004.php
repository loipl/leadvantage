...
<?php if(empty($postcustom['_optthemes_externalvideo'])) { ?><script type="text/javascript" src="<?php echo get_bloginfo('template_directory'); ?>/js/flowplayer-3.2.4.min.js"></script><?php } // Nick 11/19/2010 ?>
