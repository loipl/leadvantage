...
/*
Include all of the widgets that are included with this theme.
*/
if (is_dir ($ws_theme__temp_dir = TEMPLATEPATH . "/includes/widgets"))
...
/*
Include all of the child-config widgets that are included with this theme.
*/
if (is_dir ($ws_theme__temp_dir = TEMPLATEPATH . "/includes/cc-incs/widgets"))
	foreach (scandir ($ws_theme__temp_dir) as $ws_theme__temp_s) /* Scan all files. */
		if (preg_match ("/^([a-z_0-9\-]+)$/", $ws_theme__temp_s) && file_exists ($ws_theme__temp_dir . "/" . $ws_theme__temp_s . "/" . $ws_theme__temp_s . ".php"))
			include_once $ws_theme__temp_dir . "/" . $ws_theme__temp_s . "/" . $ws_theme__temp_s . ".php";
/**/
unset ($ws_theme__temp_dir, $ws_theme__temp_s);
/*
Check for the existence of external widget dependencies and alert the site owner if needed.
*/
foreach ($GLOBALS["WS_THEME__"]["c"]["external_widget_dependencies"] as $ws_theme__temp_a)
	/**/
