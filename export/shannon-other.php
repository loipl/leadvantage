...
$userIDs = listEligibleUserIDs($lwDb, array('EDU', 'FIN', 'INS'));
if (!$userIDs) {
...
LEFT JOIN profiles_inferred AS c3 ON a.id = c3.profile_id AND c3.token = 'lead_id'
WHERE
a.email IS NOT NULL
...
header("Content-Disposition: attachment; filename=shannon-other.csv");
