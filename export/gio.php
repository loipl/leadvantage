...
AND (a.email NOT LIKE '%@yahoo.%' AND a.email NOT LIKE '%@ymail.%' AND a.email NOT LIKE '%@gmail.%' AND a.email NOT LIKE '%@aol.%' AND a.email NOT LIKE '%@aim.%')
...
header("Content-Disposition: attachment; filename=gio.csv");
