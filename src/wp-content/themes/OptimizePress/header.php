...
<?php
	switch(stripcslashes($postcustom['_optthemes_preheadlinefont'][0])) {
...
.main-preheadline{color:#<?=$mainpreheadline?> !important;<?=$preheadlinecss?>;<?=$squeezepreheadlinefontsize?><?=$squeezepreheadlinefontweight?><?=$squeezepreheadlinefontstyle?><?=$squeezepreheadlineletterspacing?>}
.main-preheadline em{color:#<?=$mainpreheadlineem?> !important;<?=$preheadlinecss?>;<?=$squeezepreheadlinefontsize?><?=$squeezepreheadlinefontweight?><?=$squeezepreheadlinefontstyle?><?=$squeezepreheadlineletterspacing?>}
...
.main-headline{color:#<?=$headlinecolor?> !important;<?=$headlinecss?>;<?=$squeezeheadlinefontsize?><?=$squeezeheadlinefontsize?><?=$squeezeheadlinefontweight?><?=$squeezeheadlinefontstyle?><?=$squeezeheadlineletterspacing?>}
.main-headline em{color:#<?=$headlinecolorem?> !important;<?=$headlinecss?>;<?=$squeezeheadlinefontsize?><?=$squeezeheadlinefontsize?><?=$squeezeheadlinefontweight?><?=$squeezeheadlinefontstyle?><?=$squeezeheadlineletterspacing?>}
...
.main-bottomheadline{color:#<?=$mainbottomheadline?> !important;<?=$bottomheadlinecss?>;<?=$squeezeheadlinebelowvideofontsize?><?=$squeezeheadlinebelowvideofontweight?><?=$squeezeheadlinebelowvideofontstyle?><?=$squeezeheadlinebelowvideoletterspacing?>}
.main-bottomheadline em{color:#<?=$mainbottomheadlineem?> !important;<?=$bottomheadlinecss?>;<?=$squeezeheadlinebelowvideofontsize?><?=$squeezeheadlinebelowvideofontweight?><?=$squeezeheadlinebelowvideofontstyle?><?=$squeezeheadlinebelowvideoletterspacing?>}
...
.main-postheadline{color:#<?=$mainpostheadline?> !important;<?=$postheadlinecss?>;<?=$squeezesubheadlinefontsize?><?=$squeezesubheadlinefontweight?><?=$squeezesubheadlinefontstyle?><?=$squeezesubheadlineletterspacing?>}
.main-postheadline em{color:#<?=$mainpostheadlineem?> !important;<?=$postheadlinecss?>;<?=$squeezesubheadlinefontsize?><?=$squeezesubheadlinefontweight?><?=$squeezesubheadlinefontstyle?><?=$squeezesubheadlineletterspacing?>}
...
.sales-preheadline{color:#<?=$mainsalespreheadline?> !important;<?=$preheadlinecss?>;<?=$salespreheadlinefontsize?><?=$salespreheadlinefontweight?><?=$salespreheadlinefontstyle?><?=$salespreheadlineletterspacing?>}
.sales-preheadline em{color:#<?=$mainsalespreheadlineem?> !important;<?=$preheadlinecss?>;<?=$salespreheadlinefontsize?><?=$salespreheadlinefontweight?><?=$salespreheadlinefontstyle?><?=$salespreheadlineletterspacing?>}
...
.sales-postheadline{color:#<?=$mainsalespostheadline?> !important;<?=$salessubheadlinefontsize?><?=$salessubheadlinefontweight?><?=$salessubheadlinefontstyle?><?=$salessubheadlineletterspacing?>}
.sales-postheadline em{color:#<?=$mainsalespostheadlineem?> !important;<?=$salessubheadlinefontsize?><?=$salessubheadlinefontweight?><?=$salessubheadlinefontstyle?><?=$salessubheadlineletterspacing?>}
...
.launchtopheadline{ <?=$salesheadlinefontsize?><?=$salesheadlinefontweight?><?=$salesheadlinefontstyle?><?=$salesheadlineletterspacing?> }
.launchbottomheadline{ <?=$salesheadlinebelowvideofontsize?><?=$salesheadlinebelowvideofontweight?><?=$salesheadlinebelowvideofontstyle?><?=$salesheadlinebelowvideoletterspacing?>  }
.sidebar-headline{color:#<?=$sidebarheadlinecolor?> !important;<?=$sidebarheadlinecss?>;}
...
#launchbk p {font-family:<?=$mainbodytextfont?>;}
#launchbk h2{font-family:<?=$mainbodytextfont?>;}
#launchbk h3{font-family:<?=$mainbodytextfont?>;}
#launchbk h1{font-family:<?=$mainbodytextfont?>;}
body{font-family:<?=$mainbodytextfont?>;background-image:<?=$bgimgurl?>;}
...
.launch1navbar a.CurrentLinkActiveClass{color:#<?=$currentsalespagenavcolor?>}
