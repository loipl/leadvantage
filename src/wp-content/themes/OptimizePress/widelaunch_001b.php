...
<?php if(empty($postcustom['_launchpage_externalvideo'])) { ?><script type="text/javascript" src="<?php echo get_bloginfo('template_directory'); ?>/js/flowplayer-3.2.4.min.js"></script><?php } ?>
...
<?php
   $launchvideocontainerheight = !empty($postcustom['_launchpage_videoheight']) ? stripcslashes($postcustom['_launchpage_videoheight'][0])."px" :  "360px";
...
<?php } else { ?>
 ...
 <style>#launchvideobox{height:<?=$videoheight?>;width:<?=$videowidth?>;}
 #videobox{height:<?=$videoheight?>;width:<?=$videowidth?>;}</style>
