...
<?php if(empty($postcustom['_launchpage_externalvideo'])) { ?>
...
<style>
#launchheader {
<?php echo ($header_height) ? "height:".$header_height."px" : "";
?>;
background-image:url(<?php echo $launchheader;
?>);
	margin:0px auto;
}
.launchheaderlogo {
background-position:<?php echo $logo_align;
?> center;
background-image:url(<?php echo $launchheaderlogo;
?>);
<?php echo ($header_height) ? "height:".$header_height."px" : "";
?>;
	width:977px;
...
#headertext {
<?php echo ($header_height) ? "line-height:".$header_height."px" : "";
?>;
	text-align:center;
	width:977px;
<?php echo ($header_height) ? "height:".$header_height."px" : "";
?>;
font-size:<?php echo ($postcustom['_launchpage_headertextsize']) ? $postcustom['_launchpage_headertextsize'][0].'px' : '48px';
?>;
	letter-spacing:-2px;
	font-weight:normal;
}
#headerfullwidth {
<?php echo ($header_fullwidth) ? "background-image:url(".$header_fullwidth.");" : "";
?>margin:0px auto;
}
...
<!-- Close Headlines -->
    ...
    <div id="launchvideocontainer" style="width:<?php echo $launchvideocontainerwidth; ?>; height:<?php echo $launchvideocontainerheight; ?>;">
      ...
      <div id="launchvideobox">
        ...
        <style>
#launchvideobox{height:<?=$videoheight?>;width:<?=$videowidth?>;}
...
<!--
        ...
        var myQTObject = new QTObject("", "<?php echo ($postcustom['_launchpage_mobilevideourl']) ? $postcustom['_launchpage_mobilevideourl'][0] : ''; ?>", "<?=$videowidth?>", "<?=$videoheight?>");
...
//-->
        ...
        <div id="videobox3"  style="width:<?=$videowidth?>;height:<?=$videoheight?>;">
          <div id='mediaspace'>
            <center>
  ...
  so.addVariable('file','<?=$videourl?>');  so.addVariable('image','<?php echo ($postcustom['_launchpage_videoimage1']) ? $postcustom['_launchpage_videoimage1'][0] : ''; ?>');
...
<fb:comments url="<?php echo $thesharelink; ?>" xid="<?php echo ($postcustom['_launchpage_facebookxid']) ? $postcustom['_launchpage_facebookxid'][0] : $post->ID; ?>" publish_feed="true" migrated="1" reverse="false" numposts="<?php echo ($postcustom['_launchpage_fbcommentnum']) ? $postcustom['_launchpage_fbcommentnum'][0] : '20'; ?>" <?php echo ($postcustom['_launchpage_fbemailnotify']) ? 'send_notification_uid="'.$postcustom['_launchpage_fbemailnotify'][0].'" ' : ''; ?> width="600"></fb:comments>
...
<div id="fb-root"  style="padding-top:8px;"></div><script src="http://connect.facebook.net/en_US/all.js#appId=<?php echo ($postcustom['_launchpage_facebookapikey']) ? $postcustom['_launchpage_facebookapikey'][0] : ""; ?>&amp;xfbml=1"></script>
<fb:comments url="<?php echo $thesharelink; ?>" xid="<?php echo ($postcustom['_launchpage_facebookxid']) ? $postcustom['_launchpage_facebookxid'][0] : $post->ID; ?>" publish_feed="true" migrated="1" reverse="false" numposts="<?php echo ($postcustom['_launchpage_fbcommentnum']) ? $postcustom['_launchpage_fbcommentnum'][0] : '20'; ?>" <?php echo ($postcustom['_launchpage_fbemailnotify']) ? 'send_notification_uid="'.$postcustom['_launchpage_fbemailnotify'][0].'" ' : ''; ?> width="600"></fb:comments>
...
<div id="footer">
  <div id="footer-inside">
    ...
    <div class="footer-left">Copyright &copy; <?php echo ($footer_text) ? stripslashes($footer_text) : ""; ?> <?php echo ($footer_poweredby) ? ( ($footer_afflink) ? '<a href="'.$footer_afflink.'">Powered by OptimizePress</a>' : 'Powered by OptimizePress' ) : ''; ?> </div>
...
<?php
// only loads the cufon style that are going to use
