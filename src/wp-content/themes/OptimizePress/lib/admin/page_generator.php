    ...
    foreach ( $posts as $post ) {
        if ( $group == '' ) {
			...
			if($launch) :
				...
				/* contents from http://freelancinguniversity.com/instant-page-squeeze-01/ */
				update_post_meta( $post->ID, '_optthemes_bulletstyle', 'style1' );
				update_post_meta( $post->ID, '_optthemes_images', 'http://freelancinguniversity.com/wp-content/uploads/images/video1.jpg' );
				...
				update_post_meta( $post->ID, '_optthemes_buttonselect', 'http://freelancinguniversity.com/wp-content/themes/OptimizePress/images/optbuttons/red_sendmethevideo.png' );
...
<script type="text/javascript" src="<?=$templatedir?>/lib/admin/js/fancybox/jquery.fancybox-1.3.4.pack.js"></script>
<link rel="stylesheet" type="text/css" href="<?=$templatedir?>/lib/admin/js/fancybox/jquery.fancybox-1.3.4.css" media="screen" />
...
<div id="op_<?php echo $value['id']; ?>" class="fieldsection" style="margin:0 20px;">
                ...
                <span style="color:#666666;font-size:12px;font-family:arial,helvetica,sans-serif;"><?php echo $value['desc']; ?></span>
                <a style="font-size:11px;text-decoration:none;" id="scr_<?php echo $value['id']; ?>" href="<?=$templatedir?>/lib/admin/contents/images/<?php echo $value['scr']; ?>">Preview</a>
<?php
echo ( $value[ 'help' ] ) ? ' <span class="help" id="' . $value[ 'id' ] .'_help" title="' . $value[ 'help' ] . '"> </span>' : '';
echo ( $value[ 'videotxt' ] ) ? ' <a href="' . $value[ 'videolink' ] .'" target="_blank"><span class="video" id="' . $value[ 'id' ] .'_video" title="' . $value[ 'videotxt' ] . '"> </span></a>' : '';
?>
