...
<style>body{font-family:<?=$mainbodytextfont?>;background: #e7e7e7 url(<?=$url?>/images/style1a-mainbg.png);background-repeat:repeat-x;}
...
alert(msg);
    ...
    <?php $autoplay = !empty($postcustom['_optthemes_autoplay']) ? "true" :  "false"; ?>
     ...
     <style>body{background: #e7e7e7 url(<?=$url?>/images/style1a-mainbg.png);background-repeat:repeat-x;}</style>
...
<fb:comments url="<?php echo $thesharelink; ?>" xid="<?php echo ($postcustom['_optthemes_facebookxid']) ? $postcustom['_optthemes_facebookxid'][0] : $post->ID; ?>" publish_feed="true" migrated="1" reverse="false" numposts="<?php echo ($postcustom['_optthemes_fbcommentnum']) ? $postcustom['_optthemes_fbcommentnum'][0] : '20'; ?>" width="560"></fb:comments>
