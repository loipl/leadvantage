...
How to include custom JavaScript routines for a specific color variation:
	...
	3. Duplicate this process for as many custom files as you'd like to include.
		...
		* Any file ending with `.js` in the `custom/` directory will be included with PHP using: `include_once`.
...
Need to include custom JS files globally, for all color variations?
