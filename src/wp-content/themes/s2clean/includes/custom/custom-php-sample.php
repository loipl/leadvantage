<?php
/*
With this file, you can include your own custom PHP functions, Hooks and/or Filters.
...
How to include custom PHP functions globally for all color variations:
	...
	3. Duplicate this process for as many custom files as you'd like to include.
		...
		* Any file ending with `.php` in the `/includes/custom/` directory will be included using: `include_once`.
...
Need to include custom PHP files ONLY for a specific color variation?
