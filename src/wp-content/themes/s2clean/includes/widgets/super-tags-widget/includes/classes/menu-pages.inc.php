						...
						if ($verified || (($nonce = $_POST["ws_widget__super_tags_options_save"]) && wp_verify_nonce ($nonce, "ws-widget--super-tags-options-save")))
							{
								...
								$new_options = c_ws_widget__super_tags_utils_strings::trim_deep ($new_options);
								/**/
						...
						if ($_GET["page"] && preg_match ("/ws-widget--super-tags-/", $_GET["page"]))
							{
								...
								wp_enqueue_script ("jquery-sprintf", $GLOBALS["WS_WIDGET__"]["super_tags"]["c"]["dir_url"] . "/includes/jquery/jquery.sprintf/jquery.sprintf-min.js", array ("jquery"), c_ws_widget__super_tags_utilities::ver_checksum ());
								wp_enqueue_script ("jquery-json-ps", $GLOBALS["WS_WIDGET__"]["super_tags"]["c"]["dir_url"] . "/includes/jquery/jquery.json-ps/jquery.json-ps-min.js", array ("jquery"), c_ws_widget__super_tags_utilities::ver_checksum ());
								wp_enqueue_script ("jquery-ui-effects", $GLOBALS["WS_WIDGET__"]["super_tags"]["c"]["dir_url"] . "/includes/jquery/jquery.ui-effects/jquery.ui-effects-min.js", array ("jquery", "jquery-ui-core"), c_ws_widget__super_tags_utilities::ver_checksum ());
								wp_enqueue_script ("ws-widget--super-tags-menu-pages", site_url ("/?ws_widget__super_tags_menu_pages_js=" . urlencode (mt_rand ())), array ("jquery", "thickbox", "media-upload", "jquery-sprintf", "jquery-json-ps", "jquery-ui-core", "jquery-ui-effects"), c_ws_widget__super_tags_utilities::ver_checksum ());
								/**/
