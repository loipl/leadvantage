...
AND (a.email NOT LIKE '%@yahoo.%' AND a.email NOT LIKE '%@ymail.%' AND a.email NOT LIKE '%@gmail.%' AND a.email NOT LIKE '%@msn.%' AND a.email NOT LIKE '%@hotmail.%' AND a.email NOT LIKE '%@outlook.%')
...
header("Content-Disposition: attachment; filename=alex.csv");
