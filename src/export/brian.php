...
WHERE
d.request_time < DATE_ADD(NOW(), INTERVAL -60 DAY) AND d.request_time > DATE_ADD(NOW(), INTERVAL -120 DAY) AND
a.email IS NOT NULL
AND (a.email LIKE '%@yahoo.com' OR a.email LIKE '%@ymail.com' OR a.email LIKE '%@hotmail.com' OR a.email LIKE '%@live.com' OR a.email LIKE '%@msn.com' OR a.email LIKE '%@aol.com')
AND (c1.value = 'United States' OR c1.value = 'Canada')
