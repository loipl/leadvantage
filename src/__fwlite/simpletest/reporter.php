...
class HtmlReporter extends SimpleReporter {
    ...
    function paintFooter($test_name) {
        ...
        $arr = DB::getGlobalStats();
        print "<br><strong>" . number_format(microtime(true) - TEST_START_TIME, 4) . "s </strong> total time, <strong>$arr[1]s</strong> in <strong>$arr[0]</strong> calls to mysql_query().";
